...
void DIO_vSetPinDir(u8 A_u8portId,u8 A_u8PinId,u8 A_u8Mode){
	...
	case PORTA_ID:
		...
		case INPUT_PULL_UP :
			...
			//pull_up
			SET_BIT(GPIOA_PUPDR,2*A_u8PinId);
			CLR_BIT(GPIOA_PUPDR,((2*A_u8PinId)+1));
...
u8 DIO_u8GetPinVal(u8 A_u8portId,u8 A_u8PinId){
	u8 L_u8PinVal = 0;
	switch ( A_u8portId){
	case PORTA_ID: L_u8PinVal = GET_BIT(GPIOA_IDR, A_u8PinId); break;
	case PORTB_ID: L_u8PinVal = GET_BIT(GPIOB_IDR, A_u8PinId); break;
	case PORTC_ID: L_u8PinVal = GET_BIT(GPIOC_IDR, A_u8PinId); break;
	case PORTD_ID: L_u8PinVal = GET_BIT(GPIOD_IDR, A_u8PinId); break;
	case PORTF_ID: L_u8PinVal = GET_BIT(GPIOF_IDR, A_u8PinId); break;
